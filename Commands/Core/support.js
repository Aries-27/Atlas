module.exports = {
    ...
    start: async(Miku, m,{pushName}) => {
        ...
        let txt = `      🧣 *Support Group* 🧣\n\n*${botName}* is a bot for your assistance in whatsapp, and we are always happy to help you.\n\n*Link:* http://surl.li/eumln\n\n*Note:* Please don't spam in the group, and don't text *Admins directly* without permission. Ask for help in *Group*.\n\n*Thanks for using Elaina.*`
