...
module.exports = { 
    ...
    start: async ( 
      ...
      if (today.getDay() == 6 || today.getDay() == 5 || today.getDay() == 0){
          ...
          if (text == 'money') return m.reply(`*1:* Small Win --> +🪙30\n\n*2:* Small Lose --> -🪙20\n\n*3:* Big Win --> +🪙60\n\n*4:* Big Lose --> -🪙50\n\n*5:* 🎉 JackPot --> +🪙9999`)
          const fruit1= ["🥥", "🍎", "🍇"]
          const fruit2 = ["🍎", "🍇", "🥥"]  
          const fruit3 = ["🍇", "🥥", "🍎"]         
          const fruit4 = ["🍇", "🥥", "🍎"]
          ...
          if ((f1 !== f2) && f2 !== f3){
             ...
             const give1 = await eco.give(user, cara, 60); 
                   m.reply(`${mess2}\n*_Big Win -->* _🪙60_`)
          }
          else if ((f1 == f2) && f2 !== f3){
             const give2 = await eco.give(user, cara, 30);
                   m.reply(`${mess3}\n*Small Win -->* _🪙30_`)
          }
          else if ((f1 !== f2) && f1 == f3){
             ...
             const give5 = eco.give(user, cara, 9999);
                  m.reply(`${mess4}\n\n_🎊 JackPot --> _🪙9999_`)
          }
          else { 
